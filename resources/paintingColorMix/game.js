...
PS.init = function( system, options ) {
	...
	PS.debug( "INSTRUCTIONS:\nClick on one color to set it as the base\nClick on the next one to mix it!\nThe third color you click on resets the base color" );
	...
	PS.bgColor(8,0, 255, 255, 255); //white
	PS.bgColor(9,0, 127, 127, 127 ); //grey
	PS.bgColor(10,0, 0, 0, 0); //black
	...
	PS.color(8,0, 255, 255, 255);
	PS.color(9,0, 127, 127, 127 );
	PS.color(10,0, 0, 0, 0);
...
PS.touch = function( x, y, data, options ) {
	...
	if (y!==0){
		PS.color(x, y, currentMixedColor);
	}
...
PS.release = function( x, y, data, options ) {
	...
	currentColor = PS.color( x, y);
		...
		if (currentColor === PS.color(0 ,0 )||pastColor === PS.color(0 ,0 )){ // if red
			...
			if (pastColor===PS.color(8,0)||currentColor===PS.color(8,0)){ // if white
				changeCenterColor(244,153,145);
			}
			if (pastColor===PS.color(9,0)||currentColor===PS.color(9,0)){ // if grey
				changeCenterColor(180,89,81);
			}
			if (pastColor===PS.color(10,0)||currentColor===PS.color(10,0)){ // if black
		...
		if (pastColor===PS.color(3,0)||currentColor===PS.color(3,0)){ // if green
			...
			else if (pastColor===PS.color(8,0)||currentColor===PS.color(8,0)){ // if white
				changeCenterColor(255,255,170);
			}
			else if (pastColor===PS.color(9,0)||currentColor===PS.color(9,0)){ // if grey
				changeCenterColor(191,191,106);
			}
			else if (pastColor===PS.color(10,0)||currentColor===PS.color(10,0)){ // if black
	...
	else if (pastColor===PS.color(8,0)||currentColor===PS.color(8,0)){
		if (pastColor===PS.color(9,0)||currentColor===PS.color(9,0)){ // if grey
	...
	else if (pastColor===PS.color(9,0)||currentColor===PS.color(9,0)){
		if (pastColor===PS.color(10,0)||currentColor===PS.color(10,0)){ // if black
				changeCenterColor(63,63,63);
			}
	}
	currentMixedColor = PS.color(19,0);
